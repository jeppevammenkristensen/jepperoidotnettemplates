...
namespace AnalyzerCodefixCollection
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(AnalyzerCodefixCollectionCodeFixProvider)), Shared]
    public class AnalyzerCodefixCollectionCodeFixProvider : CodeFixProvider
    {
        private static string CodeFixTitle = "$CodefixTitle$";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(AnalyzerCodefixCollectionAnalyzer.DiagnosticId); }
        }
